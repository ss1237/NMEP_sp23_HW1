...
The `self.file` field provides the data as we want to read it. The data is stored in the filepath `/data/medium-imagenet/medium-imagenet-nmep-96.hdf5`, #TODO PLEASE
